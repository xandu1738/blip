...
import com.ceres.project.models.jpa_helpers.enums.BlipPackages;
import com.ceres.project.models.jpa_helpers.enums.FileCategories;
import com.ceres.project.repositories.PartnersRepository;
import com.ceres.project.services.base.BaseWebActionsService;
import com.ceres.project.utils.LocalFileManager;
...
@Service
public class PartnersService extends BaseWebActionsService {
    private final LocalFileManager localFileManager;
    private final PartnersRepository partnersRepository;

    public PartnersService(LocalFileManager localFileManager, PartnersRepository partnersRepository) {
        super();
    ...
    public OperationReturnObject switchActions(String action, JSONObject request) throws AuthorizationRequiredException {
        return switch (action){
            case "AddNewPartner" -> addNewPartner(request);
            case "EditPartnerInfo" -> editPartnerInfo(request);
            case "FetchPartnersList" -> fetchPartnersList(request);
            case "UpdatePartnerStatus" -> updatePartnerStatus(request);
