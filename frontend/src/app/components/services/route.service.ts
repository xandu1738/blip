...
export class RouteService {
    ...
    constructor(private http: HttpClient, private helper: RemoteService,protected authService:AuthService) { }

    getRoutesList(partnerCode: string, page: number, size: number): Observable<any> {
